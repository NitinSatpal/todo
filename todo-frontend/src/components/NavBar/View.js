...
const loggedIn = (email, requestLogout, history) => (
  <Menu.Menu position="right">
    <Menu.Item name="user" onClick={() => history.push('/profile/tasks')}>
      My Tasks
    </Menu.Item>
    <Menu.Item name="user" onClick={() => history.push('/profile/me')}>
      {email}
    </Menu.Item>
...
const NavBar = ({ user, requestLogout, history }) => (
  <Menu>
    <Menu.Item name="addTask" onClick={() => history.push('/task/add')}>
      Add To Do
    </Menu.Item>
    {
